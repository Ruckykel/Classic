        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 mb-12 lg:mb-0">
            ...
            <div className="flex items-start mb-12">
              ...
              <div>
                <h3 className="text-white text-2xl font-light mb-2">JOHN DOE</h3>
                <p className="text-gray-400 font-light mb-1">info@bangmedia.com</p>
            ...
            <div className="mt-12 flex space-x-6">
              <a href="#" className="text-gray-400 hover:text-blue-200 transition-colors duration-300">
            ...
            <div className="mt-16 text-gray-600 font-light text-sm">
              © 2024 BANG Media. All rights reserved.
            </div>
          </div>
